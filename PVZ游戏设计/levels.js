        ...
        this.levels = [
            ...
            },
            {
                ...
                waves: [
                    ...
                    { zombies: [{ type: 'normal', count: 12 }], isBigWave: false },
                    { zombies: [{ type: 'normal', count: 18 }, { type: 'cone', count: 6 }], isBigWave: true },
                    { zombies: [{ type: 'normal', count: 14 }, { type: 'cone', count: 8 }, { type: 'football', count: 2 }], isBigWave: false },
                    { zombies: [{ type: 'normal', count: 24 }, { type: 'cone', count: 12 }, { type: 'bucket', count: 6 }, { type: 'football', count: 4 }], isBigWave: true }
                ]
            },
            {
                id: 'autumn',
