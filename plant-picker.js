...
(function () {
    ...
    function renderPicker() {
        ...
        // 优先用 .png（本地 zip 包里一定有），加载失败时回退到 .gif（GitHub master 上才有）
        ...
        // GitHub master 上是 .gif/.webp，本地 zip 包里只有 .png
        // .png 加载失败时回退到 .gif（用 onerror 内联属性 + 事件二选一即可）
        const PICKER_IMAGE_FALLBACK = {
            '95版/reanim/CherryBomb_left1.png':  '95版/reanim/CherryBomb_left1.gif',
            '95版/reanim/Jalapeno_body.png':     '95版/reanim/Jalapeno_body.gif',
            '95版/reanim/DoomShroom_body.png':   '95版/reanim/DoomShroom_body.gif',
            '95版/reanim/IceShroom_body.png':    '95版/reanim/IceShroom_body.gif',
            '95版/reanim/Squash_body.png':       '95版/reanim/Squash_body.gif',
            '95版/reanim/Wallnut_body.png':      '95版/reanim/Wallnut_body.gif',
            '95版/reanim/Melonpult_body.png':    '95版/reanim/Melonpult_body.webp',
            '95版/reanim/SunFlower_head.png':    '95版/reanim/SunFlower_head.gif',
            '95版/reanim/SunShroom_head.png':    '95版/reanim/SunShroom_head.gif',
            '95版/reanim/PuffShroom_head.png':   '95版/reanim/PuffShroom_head.gif',
            '95版/reanim/SnowPea_head.png':      '95版/reanim/SnowPea_head.gif',
            '95版/reanim/ThreePeater_head.png':  '95版/reanim/ThreePeater_head.gif',
            '95版/reanim/PeaShooter_Head.png':   '95版/reanim/PeaShooter_Head.gif'
        };
        ...
        plantTypes.forEach(type => {
            ...
            img.alt = type;
            img.src = imageSrc;
            // 加载失败 → 回退到 .png（兼容本地 zip 包版本）
            img.addEventListener('error', function onErr() {
                const fb = PICKER_IMAGE_FALLBACK[imageSrc] ||
                           imageSrc.replace(/\.(gif|webp)$/i, '.png');
                if (this.src !== fb) {
            ...
            check.className = 'picker-checkmark';
            check.textContent = '✓';
