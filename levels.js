        ...
        this.levels = [
            {
                ...
                waves: [
                    ...
                    { zombies: [{ type: 'normal', count: 5 }, { type: 'newspaper', count: 1 }], isBigWave: false },
                    { zombies: [{ type: 'normal', count: 8 }, { type: 'cone', count: 2 }, { type: 'newspaper', count: 2 }], isBigWave: true },
                    { zombies: [{ type: 'normal', count: 6 }, { type: 'cone', count: 3 }, { type: 'football', count: 1 }], isBigWave: false },
                    { zombies: [{ type: 'normal', count: 10 }, { type: 'cone', count: 5 }, { type: 'bucket', count: 2 }, { type: 'football', count: 2 }, { type: 'gargantuar', count: 1 }], isBigWave: true }
                ]
            },
            {
                id: 'summer',
                ...
                music: 'lawnbgm(5).mp3',
                waves: [
                    { zombies: [{ type: 'normal', count: 8 }], isBigWave: false },
                    { zombies: [{ type: 'normal', count: 12 }, { type: 'newspaper', count: 2 }], isBigWave: false },
                    { zombies: [{ type: 'normal', count: 18 }, { type: 'cone', count: 6 }, { type: 'newspaper', count: 4 }, { type: 'football', count: 2 }, { type: 'gargantuar', count: 2 }], isBigWave: true },
                    { zombies: [{ type: 'normal', count: 14 }, { type: 'cone', count: 8 }, { type: 'football', count: 3 }, { type: 'gargantuar', count: 2 }], isBigWave: false },
                    { zombies: [{ type: 'normal', count: 24 }, { type: 'cone', count: 12 }, { type: 'bucket', count: 6 }, { type: 'football', count: 4 }, { type: 'gargantuar', count: 2 }], isBigWave: true }
                ]
            },
            {
                id: 'autumn',
                ...
                waves: [
                    ...
                    { zombies: [{ type: 'normal', count: 10 }, { type: 'newspaper', count: 4 }, { type: 'football', count: 1 }], isBigWave: true },
                    { zombies: [{ type: 'normal', count: 8 }, { type: 'cone', count: 4 }, { type: 'newspaper', count: 3 }, { type: 'football', count: 1 }], isBigWave: false },
                    { zombies: [{ type: 'normal', count: 13 }, { type: 'cone', count: 6 }, { type: 'bucket', count: 4 }, { type: 'newspaper', count: 5 }, { type: 'football', count: 3 }, { type: 'gargantuar', count: 1 }], isBigWave: true }
                ]
            },
            {
                id: 'winter',
                ...
                waves: [
                    ...
                    { zombies: [{ type: 'normal', count: 7 }, { type: 'newspaper', count: 1 }], isBigWave: false },
                    { zombies: [{ type: 'normal', count: 10 }, { type: 'cone', count: 4 }, { type: 'newspaper', count: 2 }], isBigWave: true },
                    { zombies: [{ type: 'normal', count: 9 }, { type: 'cone', count: 5 }, { type: 'bucket', count: 2 }, { type: 'football', count: 1 }], isBigWave: false },
                    { zombies: [{ type: 'normal', count: 14 }, { type: 'cone', count: 8 }, { type: 'bucket', count: 5 }, { type: 'football', count: 3 }, { type: 'gargantuar', count: 1 }], isBigWave: true }
                ]
            }
        ];
